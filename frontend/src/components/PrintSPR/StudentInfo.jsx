        ...
        <>
          <div className="info-container">
            <div className='two-columns-container'>
                <p className='personalInformation-title capitalized'>{text("date", language)}: </p>
                <p className='personalInformation-description justify-'>{format(new Date(), "MM/dd/yyyy")}</p>
            </div>
            <div className='two-columns-container'>
                <p className='personalInformation-title capitalized'>{text("attendance", language)}: </p>
                <p className='personalInformation-description justify-end'>{attendance} {text("times", language)}</p>
            </div>
            <div className='two-columns-container'>
                <p className='personalInformation-title capitalized'>{text("total_lessons", language)}: </p>
                <p className='personalInformation-description justify-end'>{totalLessons} {text("times", language)}</p>
                </div>
                <div className='two-columns-container'>
                   <p className='personalInformation-title capitalized'>{text("%_of_attendance", language)}: </p>
